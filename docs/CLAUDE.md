...
|---|---|---|
| `docs/architecture.md` | Stack, fluxo de dados e detalhamento de cada camada | 03/07/2026 às 03h00 BRT |
| `docs/roadmap.md` | Tarefas pendentes, em andamento e concluídas | 03/07/2026 às 03h00 BRT |
| `docs/changes.md` | Changelog de todas as alterações relevantes | 03/07/2026 às 03h00 BRT |
| `docs/integration/README.md` | Índice de todas as integrações externas documentadas | — |
