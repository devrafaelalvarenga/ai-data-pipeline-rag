...
|---|---|---|
| `docs/architecture.md` | Stack, fluxo de dados e detalhamento de cada camada | 19/07/2026 às 18h30 BRT |
| `docs/roadmap.md` | Tarefas pendentes, em andamento e concluídas | 19/07/2026 às 18h30 BRT |
| `docs/changes.md` | Changelog de todas as alterações relevantes | 19/07/2026 às 18h30 BRT |
