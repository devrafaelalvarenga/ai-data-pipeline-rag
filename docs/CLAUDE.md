...
|---|---|---|
| `docs/architecture.md` | Stack, fluxo de dados e detalhamento de cada camada | 05/07/2026 às 00h00 BRT |
| `docs/roadmap.md` | Tarefas pendentes, em andamento e concluídas | 05/07/2026 às 01h00 BRT |
| `docs/changes.md` | Changelog de todas as alterações relevantes | 05/07/2026 às 01h00 BRT |
